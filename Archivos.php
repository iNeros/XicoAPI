...
function permisos() {  
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'OPTIONS'){
    ...
    exit(0);
        ...
        $sql = "SELECT * FROM archivos WHERE  id_actividades = '".$_GET['id_actividades']."' ORDER BY id_archivo desc";
        ...
        $sql = "SELECT * FROM archivos ORDER BY id_archivo desc";
        $resultado = mysqli_query($conexion,$sql) or die ( "Algo ha ido mal en la consulta a la   base de datos");
        $datos = mysqli_fetch_all($resultado,MYSQLI_ASSOC);
        header("HTTP/1.1 200 OK");
        echo json_encode($datos);
        ...
        $sql = "INSERT INTO archivos VALUES ('".$_POST[id_archivo]."', '".$_POST[nombre]."', '".$_POST[ruta]."', '".$_POST[tipo]."', '".$_POST[id_actividades]."')";		  
        ...
        $sql = "UPDATE archivos SET `nombre`='".$_GET[nombre]."',`ruta`='".$_GET[ruta]."', `tipo`='".$_GET[tipo]."' WHERE  `id_archivo`='".$_GET[id_archivo]."';";
        ...
        $sql = "DELETE FROM archivo WHERE  `id_archivo`='".$_GET[id_archivo]."';";
