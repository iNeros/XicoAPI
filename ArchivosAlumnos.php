...
function permisos() {  
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'OPTIONS'){
    ...
    exit(0);
        ...
        $sql = "SELECT * FROM archivos_alumnos WHERE id_actividad = '".$_GET['ArchivosAct']."' and id_alumno = '".$_GET['id_alumno1']."'";
        ...
        $sql = "UPDATE archivos_alumnos SET `calificacion`='".$_GET[calificacion]."',`comentario`='".$_GET[comentario]."' WHERE `id_alumno`='".$_GET[id_alumno]."' and `id_actividad`='".$_GET[id_actividad]."';";
