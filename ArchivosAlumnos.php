...
function permisos() {  
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'OPTIONS'){
    ...
    exit(0);
        ...
        $sql = "INSERT INTO archivos_alumnos VALUES ('".$_POST[id_archivos_alumnos]."', '".$_POST[nombre]."', '".$_POST[ruta]."', '".$_POST[id_alumno]."', '".$_POST[id_actividad]."')";		  
        ...
        $sql = "UPDATE archivos_alumnos SET `nombre`='".$_GET[nombre]."',`ruta`='".$_GET[ruta]."', `id_alumno`='".$_GET[id_alumno]."', `id_actividad`='".$_GET[id_actividad]."' WHERE  `id_archivos_alumnos`='".$_GET[id_archivos_alumnos]."';";
