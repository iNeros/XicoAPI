...
function permisos() {  
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'OPTIONS'){
    ...
    exit(0);
        ...
        $usuario1 = $usuario.rand(10,99);
        $contraseña = rand(1000,9999);
        $sql = "INSERT INTO alumno VALUES (NULL,'".$_POST[nombre]."', '".$_POST[appPat]."', '".$_POST[appMat]."','".$_POST[fechaNac]."', '".$usuario1."', '".$contraseña."','".$_POST[id_grado]."');";		  
