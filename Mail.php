...
if(isset($_GET['id_docente'])){ 
    ...
    $sql = "SELECT id_grupo from grupo where id_docente = '".$_GET['id_docente']."'";
        ...
        $sqls1 = "".$sqls1." SELECT avisos.id_avisos,avisos.fecha,avisos.nombre,avisos.id_grupo from avisos where id_grupo = ".$grupo['id_grupo']." UNION ";  
        }
        $sqls1 = "".$sqls1." SELECT avisos.id_avisos,avisos.fecha,avisos.nombre,avisos.id_grupo from avisos where id_grupo = '0'";
        echo $sqls1;
        ...
        $resultado2 = mysqli_query($conexion,$sqls1) or die ( "Algo ha ido mal en la consulta a la   base de datos avisos id_final");
        echo $resultado2;
