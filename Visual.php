...
function permisos() {  
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'OPTIONS'){
    ...
    exit(0);
        ...
        $sql = "INSERT INTO visual VALUES (NULL, '".$_POST[titulo]."', '".$_POST[url]."', '".$_POST[id_grupo]."')";		  
        ...
        $sql = "UPDATE visual SET `titulo`='".$_GET[titulo]."',`url`='".$_GET[url]."',`id_grupo`='".$_GET[id_grupo]."' WHERE  `id_visual`='".$_GET[id_visual]."';";
