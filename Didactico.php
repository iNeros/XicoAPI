...
function permisos() {  
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'OPTIONS'){
    ...
    exit(0);
        ...
        if (isset($_GET['id_didactico'])) { 
        $sql = "SELECT * FROM didactico WHERE  id_didactico = '".$_GET['id_didactico']."'";
        ...
        $sql = "INSERT INTO didactico VALUES ('".$_POST[id_didactico]."', '".$_POST[titulo]."', )";		  
        ...
        $sql = "UPDATE didactico SET `titulo`='".$_GET[titulo]."' WHERE  `id_didactico`='".$_GET[id_didactico]."';";
